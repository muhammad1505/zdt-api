...
system_info() {
    ...
    echo -e "  ${_ZDT_BORDER_PRIMARY}${_BOX_VC}${RESET}${MAGENTA}${BOLD}${title_pad}${RESET}${_ZDT_BORDER_PRIMARY}${_BOX_VC}${RESET}"
    ...
    for l_text in "${sys_lines[@]}"; do
        if [ "$l_text" = "DIVIDER" ]; then
            ...
            echo -e "  ${_ZDT_BORDER_PRIMARY}${_BOX_VC}${RESET}${l_pad}${_ZDT_BORDER_PRIMARY}${_BOX_VC}${RESET}"
        fi
    done
