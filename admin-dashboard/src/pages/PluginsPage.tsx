      ...
      <div className="card bg-base-100 border border-base-200 overflow-hidden">
        {loading ? (
          ...
          <div className="text-center py-10 text-sm text-base-content/60">
            <Puzzle size={40} className="mx-auto mb-3 opacity-40" />
                ...
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${p.loaded ? 'bg-success/10' : 'bg-base-200'}`}>
                    {p.loaded
                      ...
                      : <FileCode size={20} className="text-base-content/40" />
                    }
                  </div>
                  <div>
                    ...
                    {p.file && (
                      <p className="text-[10px] text-base-content/40 mt-0.5 font-mono">{p.file}</p>
                    )}
                  </div>
                </div>
